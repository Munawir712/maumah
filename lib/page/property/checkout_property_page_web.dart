...
class CheckoutPropertyPageWeb extends StatefulWidget {
	final PropertyModel property;
	final int lamaSewa;
  const CheckoutPropertyPageWeb({Key? key, required this.property, required this.lamaSewa}) : super(key: key);

  @override
  State<CheckoutPropertyPageWeb> createState() => _CheckoutPropertyPageWebState();
}

class _CheckoutPropertyPageWebState extends State<CheckoutPropertyPageWeb> {
	late int lamaSewa;
													  ...
													  child: Column(
													  	...
													  	children: [
													  		Row(
													  			...
													  			children: [
													  				Text("Total Bayar", style:textStyle.copyWith(fontWeight: FontWeight.w500, ),),
													  				Text(
				...
				children: [
					...
					Row(
						...
						children: [
							...
							Text(
								numberFormat.format(widget.property.harga), 
								style: textStyle.copyWith(fontWeight: FontWeight.w400, color: Colors.black54),
							),
						],
					),
					const SizedBox(height: 5,),
